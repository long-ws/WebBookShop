						...
						<form action="${pageContext.request.contextPath}/category"
											...
											<c:forEach var="publisher" items="${requestScope.publishers}"
												...
												<div class="form-check">
													<input class="form-check-input" type="checkbox"
														value="${publisher}"
														id="checkbox_publisher_${status.index}"
														name="checkedPublishers"
														${requestScope.checkedPublishers.contains(publisher) ? 'checked' : '' }>
													<label class="form-check-label"
														for="checkbox_publisher_${status.index}">
														${publisher} </label>
												</div>
											</c:forEach>
										</c:when>
							...
							<article class="filter-group">
								...
								<div class="card-body pt-0">
									<div class="form-check">
										<input class="form-check-input" type="checkbox"
											value="0-50000" id="checkbox_price_1" name="priceRanges"
									...
									<div class="form-check">
										<input class="form-check-input" type="checkbox"
											value="50000-200000" id="checkbox_price_2" name="priceRanges"
											${requestScope.priceRanges.contains('50000-200000') ? 'checked' : '' }>
										<label class="form-check-label" for="checkbox_price_2">
											Từ 50.000₫ đến 200.000₫ </label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox"
											value="200000-infinity" id="checkbox_price_3"
											name="priceRanges"
								...
								<div class="card-body pt-0">
									<div class="form-check">
										<input class="form-check-input" type="radio"
											value="totalBuy-DESC" name="order" id="radio_order_1"
											${requestScope.order=='totalBuy-DESC' ? 'checked' : '' }>
										<label class="form-check-label" for="radio_order_1">
											Bán chạy nhất </label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio"
											value="createdAt-DESC" name="order" id="radio_order_2"
											${requestScope.order=='createdAt-DESC' ? 'checked' : '' }>
										<label class="form-check-label" for="radio_order_2">
											Mới nhất </label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" value="price-ASC"
											name="order" id="radio_order_3"
