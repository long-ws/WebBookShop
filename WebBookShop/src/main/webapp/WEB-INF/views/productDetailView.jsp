               ...
               <dl class="row">
                  ...
                  <dd class="col-md-9">
                     <c:choose>
                        ...
                        <c:otherwise>
                           <fmt:formatNumber pattern="#,##0" value="${requestScope.product.price * (100 - requestScope.product.discount) / 100}" />₫
												</c:otherwise>
                     </c:choose>
                  </dd>
                  ...
                  <dd class="col-md-9">
                     <c:choose>
                        <c:when test="${empty requestScope.product.imageName}">
                           <img width="280" class="img-thumbnail" src="${pageContext.request.contextPath}/img/280px.png" alt="280px.png">
                        </c:when>
                        <c:otherwise>
                           <img width="280" class="img-thumbnail" src="${pageContext.request.contextPath}/image/${requestScope.product.imageName}"
                  ...
                  <dd class="col-md-9">${requestScope.product.createdAt.format(DateTimeFormatter.ofPattern("HH:mm:ss
											dd/MM/yyyy"))}</dd>

                  <dt class="col-md-3">Ngày cập nhật</dt>
                  <dd class="col-md-9">${requestScope.product.updatedAt.format(DateTimeFormatter.ofPattern("HH:mm:ss
											dd/MM/yyyy"))}</dd>

                  <dt class="col-md-3">Ngày bắt đầu khuyến mãi</dt>
                  <dd class="col-md-9">${requestScope.product.startsAt.format(DateTimeFormatter.ofPattern("HH:mm:ss
											dd/MM/yyyy"))}</dd>
