		...
		<div class="container">
			...
			<main class="row mb-5">
				<form class="col-lg-6" method="POST"
					action="${pageContext.request.contextPath}/admin/categoryManager/update"
                   ...
                   ? 'is-invalid' : (not empty requestScope.category.name ? 'is-valid' : '')}"
					...
					<div class="mb-3">
						<label for="category-imageName" class="form-label d-block">Hình
							thể loại</label>
						<c:choose>
							<c:when test="${not empty requestScope.category.imageName}">
								<img width="50" class="img-thumbnail mb-3"
						...
						<input type="file" class="form-control" id="category-imageName"
							name="image" accept="image/*">
					</div>
					<input type="hidden" name="id" value="${requestScope.category.id}">
					<input type="hidden" name="imageName"
						value="${requestScope.category.imageName}">
