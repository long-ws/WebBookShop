...
public class CartItemResponse {
	...
	public String toString() {
		return new StringJoiner(", ", CartItemResponse.class.getSimpleName() + "[", "]").add("id=" + id)
				.add("cartId=" + cartId).add("productId=" + productId).add("productName='" + productName + "'")
				.add("productPrice=" + productPrice).add("productDiscount=" + productDiscount)
				.add("productQuantity=" + productQuantity).add("productImageName='" + productImageName + "'")
