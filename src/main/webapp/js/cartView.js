...
function checkCheckoutReady() {
    ...
    var isAddressReady = province && district && ward && addressDetail;

    document.getElementById('btnPlaceOrder').disabled = !isAddressReady;
    ...
    } else if (province && district && ward && addressDetail && deliveryPrice === 0) {
        alertBox.classList.add('show');
        alertText.textContent = 'Đang tải phương thức vận chuyển... (nếu chờ lâu, vui lòng thử lại)';
    } else if (province && district && ward && addressDetail && deliveryPrice > 0) {
    ...
    console.log('[CheckReady] province:', !!province, 'district:', !!district, 'ward:', !!ward, 'address:', !!addressDetail, 'price:', deliveryPrice, 'ready:', isAddressReady);
}
