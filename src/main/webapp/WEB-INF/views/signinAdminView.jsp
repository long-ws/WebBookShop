...
<body class="bg-light">
	<section class="section-content mx-auto"
		style="margin: 100px 0; max-width: 380px;">
		<h3 class="mb-3 p-3 text-center bg-primary text-white rounded">Shop
			Bán Sách</h3>
		<div class="card">
			<div class="card-body">
				<c:if test="${not empty requestScope.errorMessage}">
					<div class="alert alert-danger mb-3 small" role="alert">${requestScope.errorMessage}</div>
				</c:if>
				<h4 class="card-title mb-3">Đăng nhập Admin</h4>
				<p class="small">Chỉ dành cho quản trị viên và nhân viên</p>
				<form action="${pageContext.request.contextPath}/admin/signin"
					method="post">
					<div class="mb-3">
						<input name="username"
				...
				<!-- Nút quay về trang đăng nhập người dùng -->
				<div class="mt-3 text-center">
					<a href="${pageContext.request.contextPath}/signin"
						class="btn btn-secondary btn-sm"> Không phải là nhà phát triển
					</a>
				</div>
			</div>
			<!-- card-body.// -->
