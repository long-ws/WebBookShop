...
<body class="bg-slate-100 min-h-screen">
    ...
    <header class="w-full relative overflow-hidden" style="background: linear-gradient(135deg, #e0f7e6 0%, #b7ebc4 40%, #d2f5e0 100%);">
        <!-- Decorative blobs -->
    ...
    <main class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section class="bg-white rounded-xl shadow-card mb-6 overflow-hidden card-hover">
            <div class="bg-gradient-to-r from-success to-emerald-500 px-6 py-4 flex items-center justify-between">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <section class="bg-white rounded-xl shadow-card overflow-hidden card-hover">
                ...
                <div class="p-5 space-y-4">
                    <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                        <div class="w-12 h-12 bg-gradient-to-br from-success to-emerald-500 rounded-xl flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-box text-white text-lg"></i>
                        </div>
                        <div>
                            <span class="font-bold text-slate-800 block">${requestScope.shipment.shippingMethod.name != null ? requestScope.shipment.shippingMethod.name : 'GHN Express'}</span>
                            <span class="text-xs text-slate-500">${requestScope.shipment.shippingMethod.serviceTypeName != null ? requestScope.shipment.shippingMethod.serviceTypeName : 'Giao hàng nhanh chóng, an toàn'}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-semibold text-success">
                            <c:choose>
                                <c:when test="${requestScope.shipment.shippingFee == 0}">Miễn phí</c:when>
                                <c:otherwise><fmt:formatNumber pattern="#,##0" value="${requestScope.shipment.shippingFee}" />₫</c:otherwise>
                            </c:choose>
                        </span>
                    </div>
                    ...
                    <c:if test="${not empty requestScope.shipment.estimatedDeliveryDate}">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="font-semibold text-slate-800">${requestScope.shipment.estimatedDeliveryDate.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))} <c:if test="${requestScope.shipment.shippingMethod.estimatedDays > 0}">(${requestScope.shipment.shippingMethod.estimatedDays} ngày)</c:if></span>
                            </div>
                        </div>
                    </c:if>
                </div>
            ...
            <section class="bg-white rounded-xl shadow-card overflow-hidden card-hover">
                ...
                <div class="p-5 space-y-3">
                    ...
                    <div class="flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-4 py-3 rounded-xl font-semibold">
            ...
            <section class="bg-white rounded-xl shadow-card p-6 mb-6 border-2 border-amber-200">
                <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    <div class="flex items-start gap-4 flex-1">
                        <div class="w-14 h-14 bg-gradient-to-br from-warning to-amber-400 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-amber-200">
                    ...
                    <a href="${pageContext.request.contextPath}/vnpay/checkout?vnpTxnRef=${requestScope.payment.vnpTxnRef}" class="w-full lg:w-auto flex-shrink-0">
                        <button class="w-full lg:w-auto bg-gradient-to-r from-orange to-amber-500 hover:from-orange/90 hover:to-amber-500/90 text-white font-bold text-lg px-10 py-4 rounded-xl shadow-xl shadow-orange/20 hover:shadow-2xl hover:shadow-orange/30 transition-all duration-300 flex items-center justify-center gap-3 group">
