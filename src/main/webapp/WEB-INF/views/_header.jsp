					...
					<c:if test="${not empty sessionScope.currentUser}">
						...
						<li><a href="${contextPath}/cart"
								...
								<span id="total-cart-items-quantity"
									class="position-absolute top-0 end-0 mt-2 badge rounded-pill ${sessionScope.cartCount != null && sessionScope.cartCount > 0 ? 'bg-primary' : 'bg-secondary'}">${sessionScope.cartCount != null && sessionScope.cartCount > 0 ? sessionScope.cartCount : ''}</span>
