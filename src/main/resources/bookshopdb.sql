...
CREATE TABLE IF NOT EXISTS email_verify_status (
...
-- =============================================
-- PART 2: PRODUCT & CATEGORY TABLES
-- =============================================
...
-- Table for user shipping addresses (for user address book)
-- This table will be renamed to user_shipping_addresses
CREATE TABLE IF NOT EXISTS shipping_contacts (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL,
...
-- Rename shipping_contacts to user_shipping_addresses
ALTER TABLE shipping_contacts RENAME TO user_shipping_addresses;

-- =============================================
-- PART 5.5: Additional Tables (Missing from schema)
-- =============================================

-- Table for shipping weight fees (referenced by ShippingWeightFeeDAO)
CREATE TABLE IF NOT EXISTS shipping_weight_fees (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    shipping_method_id BIGINT NOT NULL,
...
-- Table for payments (referenced by PaymentDao)
...
-- Table for shipment contacts (referenced by ShippingContactDAO)
-- Note: This is different from user_shipping_addresses, this stores contacts for shipments
...
-- =============================================
-- PART 6: SEED DATA - System Tables
-- =============================================
...
('Sách giáo khoa', 'Sách giáo khoa các cấp', 'sach-giao-khoa.jpg'),
('Sách khoa học', 'Sách khoa học các loại', 'sach-khoa-hoc.png'),
('Truyện tranh', 'Truyện tranh manga, comic', 'truyen-tranh.png'),
('Tiểu thuyết', 'Tiểu thuyết VN & nước ngoài', 'tieu-thuyet.png'),
('Truyện ngắn', 'Truyện ngắn hay', 'truyen-ngan.png'),
('Truyện dài', 'Truyện dài nổi tiếng', 'truyen-dai.png'),
('Sách giáo trình', 'Sách giáo trình đại học', 'sach-giao-trinh.png'),
('Báo in', 'Các loại báo in', 'bao-in.png'),
('Tạp chí', 'Tạp chí các loại', 'tap-chi.png'),
('Tập san', 'Tập san trường học', 'tap-san.png'),
('Sách nấu ăn', 'Sách hướng dẫn nấu ăn', 'nau-an.png'),
('Sách kỹ thuật', 'Sách kỹ thuật các ngành', 'sach-ky-thuat.png'),
('Sách nông nghiệp', 'Sách nông nghiệp, trồng trọt', 'sach-nong-nghiep.png'),
('Sách thiếu nhi', 'Sách thiếu nhi, truyện tranh trẻ em', 'sach-thieu-nhi.png'),
('Sách kỹ năng sống', 'Sách phát triển bản thân', 'sach-ky-nang-song.png');
...
-- =============================================
-- FIX: Update estimated_days for shipping methods
-- =============================================
