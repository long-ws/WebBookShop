...
public interface RoleService {
	...
	Optional<Role> getRoleByCode(String code) throws BusinessException;

	List<ManageRoleResponse> getRoles(String orderBy, String orderDir) throws BusinessException;

	List<Role> getAllActiveRoles() throws BusinessException;
