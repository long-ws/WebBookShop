...
public class Order {
	...
	public String toString() {
		return new StringJoiner(", ", Order.class.getSimpleName() + "[", "]").add("id=" + id).add("userId=" + userId)
				.add("status=" + status).add("deliveryMethod=" + deliveryMethod).add("deliveryPrice=" + deliveryPrice)
